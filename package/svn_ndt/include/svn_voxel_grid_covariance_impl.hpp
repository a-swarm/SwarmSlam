#ifndef SVN_VOXEL_GRID_COVARIANCE_IMPL_HPP_
#define SVN_VOXEL_GRID_COVARIANCE_IMPL_HPP_

// Include the header declaring the class
#include <svn_voxel_grid_covariance.h> // Must include the header first
...
#endif // SVN_VOXEL_GRID_COVARIANCE_IMPL_HPP_